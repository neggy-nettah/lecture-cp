"use strict";
const CACHE_NAME="lecture-cp-shell-v0.42.1";
const BASE="/lecture-cp/";
const SHELL=[
  BASE,
  BASE+"index.html",
  BASE+"styles.css?v=0.42.1",
  BASE+"content.js?v=0.42.1",
  BASE+"progression.js?v=0.42.1",
  BASE+"rewards.js?v=0.42.1",
  BASE+"exercises.js?v=0.42.1",
  BASE+"missions.js?v=0.42.1",
  BASE+"app.js?v=0.42.1",
