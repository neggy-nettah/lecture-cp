"use strict";
const CACHE_NAME="lecture-cp-shell-v0.39.0";
const BASE="/lecture-cp/";
const SHELL=[
  BASE,
  BASE+"index.html",
  BASE+"styles.css?v=0.39.0",
  BASE+"content.js?v=0.39.0",
  BASE+"progression.js?v=0.39.0",
  BASE+"rewards.js?v=0.39.0",
  BASE+"exercises.js?v=0.39.0",
  BASE+"missions.js?v=0.39.0",
  BASE+"app.js?v=0.39.0",
