...
const probes=[
  ...
  '["lune","tomate","banane","pirate","minute","navire"].every(w=>fullyDecodableWords().some(x=>x.w===w))',
  '["maman","domino","cabane","robot","tapis","valise","miso"].every(w=>!fullyDecodableWords().some(x=>x.w===w))',
