...
const probes=[
  ...
  '(()=>{state=normalizeState({});const word=DATA.words.find(w=>w.w==="silo");gameWordEncode(word);return currentView==="word-encode"&&currentAnswer.w==="silo"&&!stage.innerHTML.includes("silo")&&stage.innerHTML.includes("Écouter le mot")})()',
